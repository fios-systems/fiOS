...
GsDeployer deploy: [
  Metacello new
    baseline: 'FIOS';
    repository: 'filetree:///opt/git/fios-systems/fiOS/repository';
    onConflictUseLoaded;
    onLock: [:ex | ex honor];
    load ].
%
...
GemStoneServerConfiguration default gemstoneIP: 'http://dev.fios.com.au'. "example IP"
